...
export type QueryableWithParamsExpression<Set extends TypeSet = TypeSet, Params extends {
...
export type $expr_WithParams<Params extends {
    [key: string]: ParamType | $expr_OptionalParam;
...
type paramsToParamArgs<Params extends {
    [key: string]: ParamType | $expr_OptionalParam;
}> = {
...
type paramsToParamExprs<Params extends {
    [key: string]: ParamType | $expr_OptionalParam;
}> = {
