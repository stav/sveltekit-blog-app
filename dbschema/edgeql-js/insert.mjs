...
export function $normaliseInsertShape(root, shape, isUpdate = false) {
    var _a;
    const newShape = {};
    const _shape = ((_a = shape.__element__) === null || _a === void 0 ? void 0 : _a.__kind__) === TypeKind.namedtuple
    ...
    for (const [key, _val] of _shape) {
        ...
        if (val === null || val === void 0 ? void 0 : val.__kind__) {
            if (val.__kind__ === ExpressionKind.Literal &&
                ...
                newShape[key] = literal(pointer === null || pointer === void 0 ? void 0 : pointer.target, val.__value__);
            }
            else {
                newShape[key] = _val;
            }
