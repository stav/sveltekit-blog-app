...
import { Duration, LocalDate, LocalDateTime, LocalTime, RelativeDuration, DateDuration, Range, } from "edgedb";
        ...
        if (refData.refCount > 1 ||
            ...
            if (!withBlock) {
                ...
                const commonParentScope = firstParentScopeChain
                    ...
                    : null;
                withBlock = commonParentScope !== null && commonParentScope !== void 0 ? commonParentScope : walkExprCtx.rootScope;
            }
            if (!withBlock) {
                throw new Error(`Cannot extract repeated expression into 'WITH' block, ` +
...
function literalToEdgeQL(type, val) {
    var _a, _b;
    const typename = (_b = (_a = type.__casttype__) === null || _a === void 0 ? void 0 : _a.__name__) !== null && _b !== void 0 ? _b : type.__name__;
    let skipCast = false;
    let stringRep;
