...
export interface ScalarType<Name extends string = string, TsType extends any = any, TsArgType extends any = TsType, TsConstType extends TsType = TsType> extends BaseType {
...
export type scalarTypeWithConstructor<S extends ScalarType, ExtraTsTypes extends any = never> = S & {
    <T extends S["__tstype__"] | ExtraTsTypes>(val: T): $expr_Literal<ScalarType<S["__name__"], S["__tstype__"], S["__tsargtype__"], T extends S["__tstype__"] ? T : S["__tstype__"]>>;
};
