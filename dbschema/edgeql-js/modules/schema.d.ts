...
export declare type $Object_32faaa35947553cf88fce68ecf1be4d9λShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
declare type $Object_32faaa35947553cf88fce68ecf1be4d9 = $.ObjectType<"schema::Object", $Object_32faaa35947553cf88fce68ecf1be4d9λShape, null, [
...
declare const Object_32faaa35947553cf88fce68ecf1be4d9: $.$expr_PathNode<$.TypeSet<$Object_32faaa35947553cf88fce68ecf1be4d9, $.Cardinality.Many>, null> 

export declare type $SubclassableObjectλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
export declare type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
declare type $ArrayExprAlias = $.ObjectType<"schema::ArrayExprAlias", $ArrayExprAliasλShape, null, [
...
export declare type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
export declare type $ConsistencySubjectλShape = $.typeutil.flatten<$InheritingObjectλShape & $AnnotationSubjectλShape & {
...
export declare type $DeltaλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
export declare type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
export declare type $PointerλShape = $.typeutil.flatten<Omit<$ConsistencySubjectλShape, "<subject"> & $AnnotationSubjectλShape & {
  "cardinality": $.PropertyDesc<$Cardinality, $.Cardinality.AtMostOne, false, false, false, false>;
  "required": $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>;
...
export declare type $SourceλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
export declare type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
export declare type $MultiRangeλShape = $.typeutil.flatten<$CollectionTypeλShape & {
  "element_type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
}>;
declare type $MultiRange = $.ObjectType<"schema::MultiRange", $MultiRangeλShape, null, [
  ...$CollectionType['__exclusives__'],
]>;
...
declare type $MultiRangeExprAlias = $.ObjectType<"schema::MultiRangeExprAlias", $MultiRangeExprAliasλShape, null, [
...
export declare type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is HasTimestamp]": $.LinkDesc<_default.$HasTimestamp, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Client]": $.LinkDesc<_default.$Client, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Tag]": $.LinkDesc<_default.$Tag, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Job]": $.LinkDesc<_default.$Job, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is Cost]": $.LinkDesc<_default.$Cost, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Payment]": $.LinkDesc<_default.$Payment, $.Cardinality.Many, {}, false, false,  false, false>;
...
export declare type $ParameterλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
declare type $RangeExprAlias = $.ObjectType<"schema::RangeExprAlias", $RangeExprAliasλShape, null, [
...
export declare type $RewriteλShape = $.typeutil.flatten<$InheritingObjectλShape & $AnnotationSubjectλShape & {
...
declare type $Rewrite = $.ObjectType<"schema::Rewrite", $RewriteλShape, null, [
  ...$InheritingObject['__exclusives__'],
  ...$AnnotationSubject['__exclusives__'],
]>;
...
export declare type $ScalarTypeλShape = $.typeutil.flatten<$PrimitiveTypeλShape & $ConsistencySubjectλShape & $AnnotationSubjectλShape & {
  "default": $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>;
...
export declare type $TriggerλShape = $.typeutil.flatten<$InheritingObjectλShape & $AnnotationSubjectλShape & {
  "subject": $.LinkDesc<$ObjectType, $.Cardinality.One, {}, false, false,  false, false>;
...
declare type $Trigger = $.ObjectType<"schema::Trigger", $TriggerλShape, null, [
  ...$InheritingObject['__exclusives__'],
  ...$AnnotationSubject['__exclusives__'],
]>;
...
declare type $TupleExprAlias = $.ObjectType<"schema::TupleExprAlias", $TupleExprAliasλShape, null, [
